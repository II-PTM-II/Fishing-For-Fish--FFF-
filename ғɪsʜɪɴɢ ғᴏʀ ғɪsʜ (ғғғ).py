...
pygame.display.set_caption("ғɪsʜɪɴɢ ғᴏʀ ғɪsʜ (ғғғ)")
# chargement de l'image de fond
fond = pygame.image.load('ᴍᴇʀ.png')
...
while running:  # boucle infinie pour laisser la fenêtre ouverte
    ...
    # affichage du score
    text = font.render(f"Fish : {player.score} ", 1, (0, 0, 0))
    ...
    for ennemi in listeEnnemis:
        ...
        if ennemi.touchPlayer(player):
            ennemi.disparaitre()
        # si l'ennemi touche le joueur alors il est attrapé
